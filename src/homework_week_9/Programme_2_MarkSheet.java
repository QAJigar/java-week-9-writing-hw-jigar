...
public class Programme_2_MarkSheet {
    public static void main(String[] args) {
        ...
        int mathaMarks = scanner.nextInt();
        while (mathaMarks <0 || mathaMarks >100){
            System.out.println("\nInvalid Input, Mark should between 0 to 100");
            System.out.println("\nPlease enter correct marks of Maths \t\t:\t");
            mathaMarks = scanner.nextInt();
        }
        ...
        int total = sum(mathaMarks, scienceMarks, englishMarks);
        int percentage = (total * 100) / 300;
        String result = calculateResult(mathaMarks, scienceMarks, englishMarks);
        String grade = calculateGrade(percentage, result);
        printTheMarkSheet(name, rollNum, mathaMarks, scienceMarks, englishMarks, total, percentage, result, grade);
