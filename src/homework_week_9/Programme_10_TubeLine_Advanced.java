...
public class Programme_10_TubeLine_Advanced {
    ...
    public static void main(String[] args) {
        ...
        String station[] = ("Aldgate,Angel,Baker Street,Bank,Barbican,bayswater,blackfriars,bond street," + "Borough,cannon street,chancery lane,charing cross,covent garden,earl's court," +
        ...
        //multidimensional array of TubeLine and Stations
